...
class ImageAugmentor:
    ...
    def _create_augmentations(self) -> A.Compose:
        ...
        # 基礎圖片處理
        aug_list.append(A.PadIfNeeded(min_height=67, min_width=83, border_mode=cv2.BORDER_CONSTANT, value=0))
        aug_list.append(A.Resize(height=67, width=83))
...
if __name__ == "__main__":
    ...
    # python image_augmentor.py --config config.yaml